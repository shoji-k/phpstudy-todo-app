...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sth = $dbh->prepare('update todos set title = :title, contents = :contents, modified = :modified where id = :id');
        ...
        $sth->bindParam(':modified', $nowStr, PDO::PARAM_STR);
...
<html lang="ja">
  ...
  <body>
    <div class="container">
        <a href="/">Home</a>
        <h1>Edit</h1>
        <form action="edit.php?id=<?= $id; ?>" method="post" class="form-group">
